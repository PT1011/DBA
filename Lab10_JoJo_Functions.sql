...
-- Question 10 Had to use ChatGPT and it told me I needed to nest concat statements
SELECT USER_NAME, STAND_NAME, 
CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT
(CONCAT('"', USER_NAME),'" wields "'),STAND_NAME),'" with power '),POWER),', but dreams of '),CONCAT(POWER * 3, '.')) AS DREAM_STATEMENT
FROM STAND_USER;
